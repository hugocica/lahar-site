    ...
    <div class="w-container">
      <div id="experimente-home" class="row-hero w-row">
        <div class="column-pad-right w-col w-col-6">
          <h1 class="h1" data-ix="show-on-scroll">Ganhe produtividade automatizando tarefas manuais.</h1>
          <div class="spacer"></div>
          <h2 class="h2" data-ix="show-on-scroll">Conheça a LAHAR, o software de automação de marketing que mais cresce no Brasil.</h2>
          <div class="spacer"></div>
          <div class="w-form" data-ix="show-on-scroll">
            <form id="email-form" name="email-form" data-name="Email Form" data-redirect="/criar-conta" redirect="/criar-conta" class="form-cta w-clearfix"><input type="text" class="field-cta-email w-input" maxlength="256" name="email" data-name="Email" placeholder="Seu endereço de e-mail" id="email" required=""><input type="submit" value="Experimente grátis" data-wait="Carregando..." class="botoes-form w-button"></form>
          ...
          <div class="txt-14-white-small" data-ix="show-on-scroll">Experimente sem compromisso. Não pedimos cartão de crédito.</div>
        </div>
    ...
    <div class="container-numbers w-container">
      <div class="w-row" data-ix="show-on-scroll">
        <div class="w-col w-col-3">
          ...
          <div class="txtblocks-blue">clientes no Brasil e em Portugal</div>
        </div>
        <div class="w-col w-col-3">
          <h1 class="h1-blue">+100</h1>
          <div class="txtblocks-blue">empresas parceiras</div>
        </div>
        <div class="w-col w-col-3">
          <h1 class="h1-blue">+5 milhões</h1>
          <div class="txtblocks-blue">de contatos gerenciados</div>
        </div>
        <div class="w-col w-col-3">
          <h1 class="h1-blue">+10 milhões</h1>
          <div class="txtblocks-blue">de e-mails disparados<br>por mês</div>
        </div>
      </div>
      <div class="spacer _50"></div><a href="#experimente-home" class="button-yellow w-button">experimente grátis</a>
      <div class="txtblocks-blue smallest" data-ix="show-on-scroll">15 DIAS GRÁTIS!</div>
    </div>
  </div>
  <div class="section-blue">
    <div class="container-center w-container">
      <div class="titulos-padding" data-ix="show-on-scroll">
        ...
        <h2 class="h2 small">Uma solução completa de Inbound Marketing para você gerar Leads qualificados para seu negócio e aumentar a produtividade da sua equipe de marketing.</h2>
      </div>
      ...
      <div class="w-row" data-ix="show-on-scroll">
        <div class="column-2 w-col w-col-6">
          ...
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Conta Multi-clientes <span class="check"></span></div>
          </div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Gerente de contas dedicado <strong class="check"></strong></div>
          </div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Possibilidade de mudar de logomarca (whitelabel) <strong class="check"></strong></div>
          </div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Relatórios úteis (ROI) <strong class="check"></strong></div>
          </div>
        </div>
        <div class="column-2 w-col w-col-6">
          ...
          <div class="spacer _30 w-hidden-tiny"></div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">CRM integrado e de terceiros <strong class="check"></strong></div>
          </div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Aumento de produtividade com a automação <strong class="check"></strong></div>
          </div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Métricas consistentes e claras sobre desempenho de marketing <strong class="check"></strong></div>
          </div>
          <div class="div-vantagens-icones">
            <div class="txtblock-medium">Interface fácil de usar <strong class="check"></strong></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="section-branca">
    <div class="container-center tab w-container">
      <div class="titulos-padding" data-ix="show-on-scroll">
        ...
        <h2 class="h2 small blue">Conheça as ferramentas que sua empresa precisa para gerenciar suas estratégias de Marketing Digital.</h2>
      </div>
              ...
              <div data-w-tab="painel" class="w-tab-pane w--tab-active">
                <div class="row-funcionalidade w-row">
                  <div class="column-descricao-funcionalidades w-col w-col-5">
                    ...
                    <div class="spacer _10"></div>
                    <div class="txtblocks-blue medium">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris dapibus fermentum metus. Suspendisse velit mi, sollicitudin quis, rutrum qui.</div>
                    <div class="spacer _50"></div><a href="funcionalidades-lahar.html" class="button-outline w-button">detalhes das funcionalidades</a></div>
              ...
              <div data-w-tab="popup" class="w-tab-pane">
                <div class="row-funcionalidade w-row">
                  <div class="column-descricao-funcionalidades w-col w-col-5">
                    ...
                    <div class="spacer _10"></div>
                    <div class="txtblocks-blue medium">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris dapibus fermentum metus. Suspendisse velit mi, sollicitudin quis, rutrum qui.<br></div>
                    <div class="spacer _50"></div><a href="funcionalidades-lahar.html" class="button-outline w-button">detalhes das funcionalidades</a></div>
                  <div class="column-imagem-funcionalidades w-col w-col-7">
                    <div data-animation="slide" data-duration="500" data-infinite="1" class="slider w-slider">
                      <div class="w-slider-mask">
  ...
  <div class="section-planos-precos">
    <div class="container-center w-container">
      <div data-ix="show-on-scroll">
        ...
        <h2 class="h2 small _20">Não importa o seu segmento, nós temos um plano certo para o seu negócio. <br>Nossos preços só aumentam com os seus resultados! Experimente sem compromisso. Não pedimos cartão de crédito.</h2>
      </div>
      <div class="spacer _50"></div>
      ...
      <div class="div-period">
        <div class="w-form" data-ix="show-on-scroll">
          <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="form-switch">
            <div id="paymentPeriodmonthButton" class="radio-button-field active w-radio"><input onchange="changePaymentPeriod(event)" data-value="month" checked="checked" type="radio" id="radio" name="radio" value="Radio" data-name="Radio" class="radio-button w-radio-input">
              <label for="radio" class="w-form-label">mensal</label></div>
            <div id="paymentPeriodyearButton" class="radio-button-field w-radio">
              <input onchange="changePaymentPeriod(event)" data-value="year" type="radio" id="radio-2" name="radio" value="Radio" data-name="Radio 2" class="radio-button w-radio-input"><label for="radio-2" class="w-form-label">anual</label></div>
          </form>
          <div class="w-form-done">
      ...
      <div class="w-row" data-ix="show-on-scroll">
        ...
        <div class="column-zero-pad w-col w-col-3">
          <div class="div-content-planos destaque">
            <div class="parte-cima">
        ...
        <div class="column-zero-pad w-col w-col-3">
          <div class="div-content-planos">
            ...
            </div><a href="corporativo.html" class="link-nav cta _100percent w-button">SAIBA MAIS</a></div>
        </div>
      </div><a href="planos-e-precos.html" class="buttons-outline w-button" data-ix="show-on-scroll">COMPARE OS PLANOS</a></div>
  </div>
    ...
    <div id="experimente" class="section-cta _2">
      <div class="container-center w-container">
        <div class="div-align-left" data-ix="show-on-scroll">
          ...
          <div class="spacer _30"></div><a href="#experimente-home" class="button-yellow w-button">EXPERIMENTE GRÁTIS</a></div>
      </div>
    </div>
  ...
  <div class="section-parceiros">
    <div class="container-center w-container">
      <div class="titulos-padding" data-ix="show-on-scroll">
        ...
        <h2 class="h2 small blue">Disponibilizamos um pacote de benefícios e diferenciais para agências, consultores e profissionais de marketing e vendas. Seja parceiro LAHAR e garanta resultados reais para seu negócio e de seus clientes.</h2>
      </div>
      <div class="spacer _50"></div>
      <div data-animation="slide" data-hide-arrows="1" data-duration="500" data-infinite="1" class="slider-testimonials w-slider" data-ix="show-on-scroll">
        <div class="mask w-slider-mask">
          <div class="slide-testimonial w-slide">
            <div class="txt-20">“Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per.”</div>
            <div class="spacer _50"></div>
            <div class="title-testimonial">Nome do Autor</div>
            <div class="txtblocks-blue medium center">Empresa</div>
          </div>
          <div class="slide-testimonial w-slide">
            <div class="txt-20">“Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per.”</div>
            <div class="spacer _50"></div>
      ...
      <div class="spacer _50"></div><a href="parceria.html" class="button-outline w-button" data-ix="show-on-scroll">CONHEÇA E INSCREVA-SE</a></div>
  </div>
  <div class="section-trio">
    ...
    <div class="section-trio-implantacao _2">
      <div class="container-center w-container">
        <div class="div-align-left _60" data-ix="show-on-scroll">
          ...
          <h2 class="h2 small _20">Temos uma equipe de especialistas com mais de 15 anos de experiência em estratégias de tecnologia e internet marketing. Quer aprender como seu negócio pode ter resultados com nosso software de automação de marketing?</h2><a href="implementacao-lahar.html" class="buttons-outline smallpad w-button">SAIBA MAIS</a></div>
      </div>
    </div>
  ...
  <div class="section-footer home">
    <div class="container-footer w-container">
      ...
      <div class="div-20-percent _3">
        <div class="txtblocks-blue medium title">LAHAR</div><a href="https://blog.lahar.com.br/" target="_blank" class="txtblocks-blue medium links">Blog</a><a href="trabalhe-na-lahar.html" class="txtblocks-blue medium links">Trabalhe Conosco</a><a href="cases-de-marketing-digital.html" class="txtblocks-blue medium links">Histórias de sucesso</a><a href="http://ajuda.lahar.com.br/" target="_blank" class="txtblocks-blue medium links">Central de ajuda</a>
        <div class="footer-blog">
          <div class="txtblocks-blue medium title">DESTAQUES DO BLOG</div><a href="#" class="txtblocks-blue medium links">7 dicas de e-mail marketing para aumentar suas vendas B2B <span class="novo">NOVO</span></a><a href="#" class="txtblocks-blue medium links">7 dicas de e-mail marketing para aumentar suas vendas B2B</a><a href="#" class="txtblocks-blue medium links">7 dicas de e-mail marketing para aumentar suas vendas B2B</a><a href="#" class="txtblocks-blue medium links">7 dicas de e-mail marketing para aumentar suas vendas B2B</a><a href="#" class="txtblocks-blue medium links">7 dicas de e-mail marketing para aumentar suas vendas B2B <span class="novo">NOVO</span></a></div>
      </div>
      <div class="div-20-percent">
        <div class="txtblocks-blue medium title">EXPLORE</div><a href="funcionalidades-lahar.html" class="txtblocks-blue medium links">Funcionalidades</a><a href="planos-e-precos.html" class="txtblocks-blue medium links">Planos e preços</a><a href="parceria.html" class="txtblocks-blue medium links">Programa de parceiros</a><a href="implementacao-lahar.html" class="txtblocks-blue medium links">Implementação do software</a><a href="corporativo.html" class="txtblocks-blue medium links">Corporativo</a>
